...
- **Dashboard pattern (customer-shareable):** the public [Copilot Metrics Viewer](https://octodemomvs.github.io/octodemo/) exposes IDE DAU, agent adoption %, most-used chat model, top feature, requests-per-chat-mode, completion acceptance rate. Use the screenshot/structure; do not cite octodemo as a customer-bound source.
