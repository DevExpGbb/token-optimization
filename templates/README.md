...
4. Move repeated task workflows into `.prompt.md` files.
5. Scope MCP servers to the workspace when the tool is only needed for that repository.
...
| `chatmodes/*.chatmode.md` | `.github/chatmodes/` or `.vscode/chatmodes/` |
